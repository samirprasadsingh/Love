...
function openDoor() {
    ...
    // FIX: the heart door halves are hinged at the centre seam via CSS
    // (transform-origin set in style.css), so we just toggle a class
    // instead of overriding transform-origin / transform inline here.
...
/*=========================================
        ...
        (NEW: a gentle, continuous heart-fall
        effect runs across the whole site, not
        just once when the door opens)
=========================================*/
...
setInterval(spawnAmbientHeart, 600);
...
function spawnFireworks() {
    ...
    const colors = ["#ff6b9d", "#ff5c8d", "#ffb6c1", "#ffffff"];
